...
(function () {
    ...
    var bj = true, cn = true, be = true, aJ = "starttime";
    var aN = true;
    var bQ = [];
    var bw = [];
    var cd = [];
    ...
    var bG = function (cR) {
        var cS, cO = {}, cT, cP = this, cN = false, cL, cQ, cM = {x: 10, y: 66}, cK = {x: 5, y: 1};
        this.move = function () {
            cL = cL + cK.x;
            cQ = cQ + cK.y;
            if (cL < cM.x) {
        ...
        this.init = function () {
            ...
            cT.css(cR, cM.x + "px").css({top: cM.y + "px"}).on("mouseenter", cP.stop).on("mouseleave", cP.resize).children("a.close").on("click", cP.hidden);
            $("body").append(cT);
            cL = cM.x;
            cQ = cM.y;
            cP.resize()
    ...
    function t() {
        ...
        if (cM && cM.length > 0) {
            for (var cL = 0; cL < cM.length; cL++) {
                var cK = $(cM[cL]).attr("hbid").split("#")[0];
                if (cK == $("#train_date").val()) {
                    $(cM[cL]).find('a[class="del"]').click()
                }
                var cO = $(cM[cL]).attr("hbid").split("#");
    ...
    function b2(cL) {
        if (cL) {
            ...
            cK.removeClass("btn92").addClass("btn92s").show();
            ifAlertCode = true
        } else {
            $(".yzm").hide();
            $("#orange_msg").show();
    ...
    function aM(cK) {
            ...
            if (cR > 0 && a4) {
                ...
                if (!$("#autoSubmit").is(":checked")) {
                    ...
                    if (ccSelected.length > 0 || rqChecked.length > 0 || xbChecked.length > 0) {
                        ...
                        if (train_tour_flag == "fc") {
                            var cS = "成功查到" + $("#back_train_date").val() + "的" + b5[0]["queryLeftNewDTO"]["station_train_code"] + "次"
                        } else {
                            var cS = "成功查到" + $("#train_date").val() + "的" + b5[0]["queryLeftNewDTO"]["station_train_code"] + "次"
                        }
                        if (cR == 1) {
                            cS = cS + "车。"
                        } else {
                ...
                $("#filterTicDiv").html("<strong>离下次刷新时间<font class='colorA' style='font-size: 16px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + cQ + "</font>秒<strong>");
                countDown = window.setInterval(function () {
                    var cT = "<strong>离下次刷新时间<font class='colorA' style='font-size: 16px;'>";
                    if (cQ == 0) {
        ...
        for (var cL = 0; cL < cK.length; cL++) {
            ...
            cP.push("<div><a  " + cO + ' title="点击查看停靠站信息" href="javascript:" id="');
            cP.push(cK[cL].queryLeftNewDTO.train_no);
            cP.push("_");
            cP.push(cK[cL].queryLeftNewDTO.from_station_telecode);
            cP.push("_");
            cP.push(cK[cL].queryLeftNewDTO.to_station_telecode);
            if ("1" == cK[cL].queryLeftNewDTO.controlled_train_flag || "2" == cK[cL].queryLeftNewDTO.controlled_train_flag) {
            ...
            if (cK[cL].queryLeftNewDTO.is_support_card != 0) {
                cP.push(' <span class="i-card" title="可凭二代身份证直接进出站"></span>')
            }
            cP.push("</div>");
            cP.push('<span id="');
            cP.push(cK[cL].queryLeftNewDTO.train_no);
            ...
            if ("1" == cK[cL].queryLeftNewDTO.controlled_train_flag || "2" == cK[cL].queryLeftNewDTO.controlled_train_flag) {
                cP.push('" class="lookup"><span style="display:none;">查看票价</span><b style="display:none;" title="查看票价"></b></span>')
            } else {
                cP.push('" class="lookup" onclick="showTicketPrice(this)"><span style="display:none;">查看票价</span><b title="查看票价"></b></span>')
            }
            cP.push("</div>");
            cP.push('<div class="cdz">');
            if (cK[cL].queryLeftNewDTO.from_station_telecode != null && cK[cL].queryLeftNewDTO.from_station_telecode == cK[cL].queryLeftNewDTO.start_station_telecode) {
            ...
            if (cK[cL].queryLeftNewDTO.to_station_telecode != null && cK[cL].queryLeftNewDTO.to_station_telecode == cK[cL].queryLeftNewDTO.end_station_telecode) {
            ...
            if ("1" == cK[cL].queryLeftNewDTO.controlled_train_flag || "2" == cK[cL].queryLeftNewDTO.controlled_train_flag) {
                ...
                cP.push("</strong>");
                cP.push("<span>");
                cP.push(changeArriveDate(cK[cL].queryLeftNewDTO.start_time, cK[cL].queryLeftNewDTO.lishi));
                cP.push("到达</span>")
            }
            cP.push("</div>");
            cP.push("</div>");
            cP.push("</td>");
            if (cK[cL].queryLeftNewDTO.swz_num && cK[cL].queryLeftNewDTO.swz_num != "--" && cK[cL].queryLeftNewDTO.swz_num != 0 && cK[cL].queryLeftNewDTO.swz_num != "无") {
                cr(cP, cK[cL].queryLeftNewDTO.swz_num, "SWZ_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "91", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL])
            } else {
                if (cK[cL].queryLeftNewDTO.tz_num && cK[cL].queryLeftNewDTO.tz_num != "--" && cK[cL].queryLeftNewDTO.tz_num != 0 && cK[cL].queryLeftNewDTO.tz_num != "无") {
                    cr(cP, cK[cL].queryLeftNewDTO.tz_num, "TZ_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "P1", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL])
                } else {
                    if (cK[cL].queryLeftNewDTO.swz_num && cK[cL].queryLeftNewDTO.swz_num == "无") {
                        cr(cP, cK[cL].queryLeftNewDTO.swz_num, "SWZ_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "91", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL])
                    } else {
                        cr(cP, cK[cL].queryLeftNewDTO.tz_num, "TZ_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "P1", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL])
                    }
            ...
            cr(cP, cK[cL].queryLeftNewDTO.zy_num, "ZY_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "M1", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.ze_num, "ZE_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "O1", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.gr_num, "GR_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "61", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.rw_num, "RW_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "41", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.srrb_num, "SRRB_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "F1", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.yw_num, "YW_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "31", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.rz_num, "RZ_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "21", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.yz_num, "YZ_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "11", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.wz_num, "WZ_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "W1", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            cr(cP, cK[cL].queryLeftNewDTO.qt_num, "QT_", cK[cL].queryLeftNewDTO.train_no, cK[cL].queryLeftNewDTO.yp_ex, "", cK[cL].queryLeftNewDTO.controlled_train_flag, cK[cL]);
            if ("Y" == cK[cL].queryLeftNewDTO.canWebBuy) {
                cP.push(' <td align="center" width="80" class="no-br"><a href="javascript:" class="btn72" onclick="checkG1234(\'');
            ...
            cP.push("</tr>");
            cP.push('<tr datatran="' + cK[cL].queryLeftNewDTO.station_train_code + '" id="price_');
            cP.push(cK[cL].queryLeftNewDTO.train_no);
    ...
    function aT(cK) {
        if (cK && cK.length > 0) {
            for (var cL = cK.length - 1; cL >= 0; cL--) {
                if (cK[cL].queryLeftNewDTO.exchange_train_flag == 0 || cK[cL].queryLeftNewDTO.canWebBuy != "Y") {
                    cK.splice(cL, 1)
                }
            }
        }
    ...
    function an(cQ, cK) {
        ...
        if (hainan_limit_start_traindate && G(cN) >= G(hainan_limit_start_traindate)) {
            if (hainan_limit_from_telcode && hainan_limit_to_telcode) {
                for (var cL = 0, cP = cK.length; cL < cP; cL++) {
                    ...
                    if (hainan_limit_from_telcode.indexOf(cR) > -1 && hainan_limit_to_telcode.indexOf(cO) > -1 && cM.indexOf("起售") > -1) {
                        return true
                    }
                }
            }
    ...
    function cr(cT, c4, c1, cX, c2, cV, cR, cU) {
        ...
        var cP = $("#train_date").val() + "#" + cM.from_station_telecode + "#" + cM.to_station_telecode + "#" + cM.train_no + "#" + c1 + "#" + cM.from_station_no + "#" + cM.from_station_name + "#" + cM.to_station_no + "#" + cM.to_station_name + "#" + cU.secretStr + "#" + cM.station_train_code + "#";
        ...
        if (!cU.secretStr || "null" == cU.secretStr) {
            cY = false
        }
        if (tour_flag == "fc" || tour_flag == "gc") {
            cY = false
        ...
        if (cV == "") {
            ...
            for (var cZ = 0; cZ < cK.length; cZ++) {
                if (cZ % 2 == 0 && cK[cZ] != "9" && cK[cZ] != "P" && cK[cZ] != "M" && cK[cZ] != "O" && cK[cZ] != "6" && cK[cZ] != "4" && cK[cZ] != "F" && cK[cZ] != "3" && cK[cZ] != "2" && cK[cZ] != "1" && cK[cZ] != "W") {
                    if (cK[cZ + 1] == "1") {
                        c0 = true;
                        break
                    }
        ...
        if ("1" == cR || "2" == cR) {
            ...
            if ("有" == c4) {
                if (c1 == "SWZ_" || c1 == "TZ_") {
                    cT.push('<td hbdata="' + cL + '" hbid="' + cP + '" width="46" align="center" class="yes" onclick="showTicketPrice(this)"　style="cursor: pointer;" id="');
                    cT.push(c1);
                    cT.push(cX);
                    cT.push('">');
                    if (c0) {
                        cT.push('<div class="sale" title="本席别票价打折">' + c4 + '<span class="i-mark">折</span></div>')
                    } else {
                        cT.push(c4)
                    }
                    cT.push("</td>")
                    ...
                    if (c1 == "ZY_" || c1 == "ZE_") {
                        cT.push('<td hbdata="' + cL + '" hbid="' + cP + '" width="46" align="center" class="yes" style="cursor: pointer;" onclick="showTicketPrice(this)" id="');
                        cT.push(c1);
                        cT.push(cX);
                        cT.push('">');
                        if (c0) {
                        ...
                        cT.push('<td hbdata="' + cL + '" hbid="' + cP + '" width="46" align="center" style="cursor: pointer;" class="yes" onclick="showTicketPrice(this)" id="');
                        cT.push(c1);
                        cT.push(cX);
                        cT.push('">');
                        if (c0) {
                ...
                if (c4 == "无" || isNum(c4) >= 0) {
                    ...
                    if (c1 == "SWZ_" || c1 == "TZ_" || c1 == "ZY_" || c1 == "ZE_") {
                        cT.push('<td hbdata="' + cL + '"  hbid="' + cP + '" width="46" align="center" style="cursor: pointer;' + cW + '" ' + cQ + ' onclick="showTicketPrice(this)" id="');
                        cT.push(c1);
                        cT.push(cX);
                        cT.push('">');
                        cT.push("<div>");
    ...
    function G(cL) {
        var cK = new Date();
        var cM = cL.split("-");
        cK.setFullYear(parseInt(cM[0]), parseInt(cM[1] - 1, 10), parseInt(cM[2], 10));
        if (cM.length >= 6) {
    ...
    Date.prototype.format = function (cL) {
        ...
        if (/(y+)/.test(cL)) {
            cL = cL.replace(RegExp.$1, (this.getFullYear() + "").substr(4 - RegExp.$1.length))
        }
        for (var cK in cM) {
            if (new RegExp("(" + cK + ")").test(cL)) {
                cL = cL.replace(RegExp.$1, RegExp.$1.length == 1 ? cM[cK] : ("00" + cM[cK]).substr(("" + cM[cK]).length))
            }
        }
        return cL
    };
    ...
    function bh() {
        $("#train_stop").on("mouseover", function (cK) {
    ...
    function bF() {
        ...
        $("#date_range>ul>li").each(function () {
            var cL = $(this).children("span:first-child").html();
            cK.push(cL)
        });
        $("#query_ticket").click()
    }
    ...
    function aH() {
        ...
        if (value != "" && value != undefined && value != "undefined") {
            ...
            if (cO.is_student && "Y" == cO.is_student) {
                $("#sf2").click()
            } else {
                $("#sf1").click()
            }
            if (cO.is_GDC && "Y" == cO.is_GDC) {
                $("#sear-sel-bd input[name='cc_type']")[0].click();
                $("#sear-sel-bd input[name='cc_type']")[1].click()
            }
            if (cO.auto_query && "Y" == cO.auto_query) {
                var cK = [];
                $("#date_range>ul>li").each(function () {
                    var cP = $(this).children("span:first-child").html();
                    cK.push(cP)
                });
                $("#query_ticket").click()
            }
    ...
    function aC(cM) {
        for (var cK = 1; cK <= 20; cK++) {
            var cL = $("#date_range>ul>li:nth-child(" + cK + ")").children("span:first-child").text();
            cL = "2013-" + cL;
            if (cM == cL) {
                ...
                $("#date_range>ul>li:nth-child(" + cK + ")").children("span:first-child").removeClass();
                $("#date_range>ul>li:nth-child(" + cK + ")").children("span:last-child").removeClass();
                $("#date_range>ul>li:nth-child(" + cK + ")").children("span:first-child").addClass("hide");
                $("#date_range>ul>li:nth-child(1)").children().addClass("first");
                ce = $("#date_range>ul>li:nth-child(" + cK + ")").children("span:first-child").text();
                break
            }
        }
    }
    ...
    function cf() {
        $("#change_station").bind("click", function () {
            ...
            if ((cO != "" && cO != "简拼/全拼/汉字") && (cP != "" && cP != "简拼/全拼/汉字")) {
                ...
                for (var cM = 0; cM < cN.length; cM++) {
                    var cL = cN[cM];
                    $(cL.element).next().addClass("error")
                }
                bt.checkForm()
            }
            b7()
    ...
    function b(cK) {
        dhtmlx.alert({
            title: "提示", ok: messages["button.ok"], text: cK, type: "alert-error", callback: function () {
            }
        })
    }
    ...
    function b6() {
        $("#query_ticket").unbind("click").click(function (cO) {
            $("#sel-buyer").hide();
            $("#sel-seat").hide();
            $("#sel-date").hide();
            ...
            var cL = train_tour_flag == "fc" ? $.trim($("#back_train_date").val()) : $.trim($("#train_date").val());
            var cK = b4(cL, cP);
            if (!cK) {
                return
            }
    ...
    function au(cK) {
        ...
        $.ajax({
            type: "get", isTakeParam: false, beforeSend: function (cM) {
            ...
            }, url: ctx + CLeftTicketUrl, data: cK, timeout: 10000, error: function (cM, cO, cN) {
                dhtmlx.modalbox.hide(cL);
                if ("timeout" == cO || "No Transport" == cO || "abort" == cO) {
                    if ($("#auto_query").is(":checked")) {
                        au(cK)
                    }
                }
                ...
                dhtmlx.modalbox.hide(cL);
                if (cO.status) {
                    if (cO.data == null || cO.data.length == 0 || (cO.data.result && cO.data.result.length == 0)) {
                        $("#sear-sel").hide();
                        $("#sear-result").hide();
                        $("#t-list").hide();
                        $("#_lc_link_foot").hide();
                    ...
                    for (var cP = 0; cP < cO.data.length; cP++) {
                        trainListForIE.push(cO.data[cP].queryLeftNewDTO.station_train_code + "(" + cO.data[cP].queryLeftNewDTO.start_time + "--" + cO.data[cP].queryLeftNewDTO.arrive_time + ")")
                    }
                    ...
                    if (train_tour_flag != null && train_tour_flag == "fc") {
                        var cV = "<strong>".concat($("#fromStationText").val()).concat(" --> ").concat($("#toStationText").val()).concat("（").concat(aP($("#back_train_date").val())).concat('）</strong>共计<strong id="trainum">').concat(cO.data.length).concat("</strong>个车次");
                        if (ch(cO.data)) {
                            cM = "<p class='ad-gt' id='DW_SHOW_STR' data='1'>高铁动卧 夕发朝至 风雨无阻 省时省钱</p>"
                        } else {
                            if (hainan_limit_msg && an(cK, cO.data)) {
                                cR = "<p class='ad-gt' id='hainan_limit_msg'  style='font-size:13px;background:#fff6f6 left center no-repeat;font-weight:bold'>" + hainan_limit_msg + "</p>"
                            }
                        }
                        if ($("#auto_query").is(":checked")) {
                            var cT = "";
                            ...
                            cV = cV.concat(cT + "<input type='checkbox' class='check' id='filterTic' /><div id='filterTicDiv' style='display:inline'><strong><label for='filterTic' style='cursor: pointer;'>仅查看刷到车次</label></strong></div>")
                        }
                        ...
                        var cV = "<strong>".concat($("#fromStationText").val()).concat(" --> ").concat($("#toStationText").val()).concat("（").concat(aP($("#train_date").val())).concat('）</strong>共计<strong id="trainum">').concat(cO.data.length).concat("</strong>个车次");
                        if (ch(cO.data)) {
                            cM = "<p class='ad-gt' id='DW_SHOW_STR' data='1'>高铁动卧 夕发朝至 风雨无阻 省时省钱</p>"
                        } else {
                            if (hainan_limit_msg && an(cK, cO.data)) {
                    ...
                    if (!$("#lc_msg")[0] && cR == "" && cM == "" && $("#fromStationText").attr("readonly") != "readonly" && !$("#autoSubmit").is(":checked")) {
                        var cU = '<p id="lc_msg">您可使用<a style="color:#07f" href="' + ctx + 'lcQuery/init">接续换乘</a>功能，查询途中换乘一次的部分列车余票情况。</p>';
                ...
                if (cM.status == 403) {
                    ...
                    if (cM.responseText == "0" || cM.responseText == "1" || cM.responseText == "2" || cM.responseText == "3" || cM.responseText == "4") {
    ...
    function cG(cK) {
        ...
        $("#_lc_link_foot").hide();
        $("#no_filter_ticket_2").hide();
        $("#no_filter_ticket_6").find("p").html(cK);
    ...
    function aj() {
        ...
        $("#date_range>ul>li").each(function (cP) {
            ...
            var cO = $("#date_range>ul>li:nth-child(" + (cP + 1) + ")>span[class=hide]").text().substring(0, 5) + bB(cM);
            $("#date_range>ul>li:nth-child(" + (cP + 1) + ")>span[class=hide]").text(cO);
            cL = $(this).children("span:first-child").html();
        ...
        if (index_train_date == null) {
            ...
            ce = $("#date_range>ul>li:nth-child(1)").children("span:first-child").text()
        }
        by()
    }
    ...
    function by() {
        ...
        $("#date_range>ul>li").bind("click", function () {
            ...
            if (train_tour_flag != null && train_tour_flag == "fc") {
                ...
                var cQ = $(this).children("span:first-child").text();
            ...
            $("#date_range>ul>li:nth-child(1)").children().addClass("first");
            $(this).children("span:first-child").addClass("hide");
            ce = $(this).children("span:first-child").text();
            var cM = {
    ...
    function X(cM, cL) {
        ...
        for (var cK = 0; cK < cL.length; cK++) {
            ...
            if (cL[cK] == "QT") {
                if (cM.queryLeftNewDTO.station_train_code.substring(0, 1) != "G" && cM.queryLeftNewDTO.station_train_code.substring(0, 1) != "D" && cM.queryLeftNewDTO.station_train_code.substring(0, 1) != "C" && cM.queryLeftNewDTO.station_train_code.substring(0, 1) != "T" && cM.queryLeftNewDTO.station_train_code.substring(0, 1) != "K" && cM.queryLeftNewDTO.station_train_code.substring(0, 1) != "Z") {
                    return true
                }
            }
            if (cL[cK] == "G") {
                if (cM.queryLeftNewDTO.station_train_code.substring(0, 1) == "C" || cM.queryLeftNewDTO.station_train_code.substring(0, 1) == "G") {
                    return true
                }
            }
        }
    ...
    function a7(cM, cK) {
        ...
        for (var cL = 0; cL < cK.length; cL++) {
            if (cK[cL] == "SWZ") {
                if (cM.queryLeftNewDTO.swz_num != "--" && cM.queryLeftNewDTO.swz_num != "无") {
                    aO.push("SWZ");
                    return true
                }
            }
            if (cK[cL] == "TZ") {
                if (cM.queryLeftNewDTO.tz_num != "--" && cM.queryLeftNewDTO.tz_num != "无") {
                    aO.push("TZ");
                    return true
                }
            }
            if (cK[cL] == "ZY") {
                if (cM.queryLeftNewDTO.zy_num != "--" && cM.queryLeftNewDTO.zy_num != "无") {
                    aO.push("ZY");
                    return true
                }
            }
            if (cK[cL] == "ZE") {
                if (cM.queryLeftNewDTO.ze_num != "--" && cM.queryLeftNewDTO.ze_num != "无") {
                    aO.push("ZE");
                    return true
                }
            }
            if (cK[cL] == "GR") {
                if (cM.queryLeftNewDTO.gr_num != "--" && cM.queryLeftNewDTO.gr_num != "无") {
                    aO.push("GR");
                    return true
                }
            }
            if (cK[cL] == "RW") {
                if (cM.queryLeftNewDTO.rw_num != "--" && cM.queryLeftNewDTO.rw_num != "无") {
                    aO.push("RW");
                    return true
                }
            }
            if (cK[cL] == "YW") {
                if (cM.queryLeftNewDTO.yw_num != "--" && cM.queryLeftNewDTO.yw_num != "无") {
                    aO.push("YW");
                    return true
                }
            }
            if (cK[cL] == "RZ") {
                if (cM.queryLeftNewDTO.rz_num != "--" && cM.queryLeftNewDTO.rz_num != "无") {
                    aO.push("RZ");
                    return true
                }
            }
            if (cK[cL] == "YZ") {
                if (cM.queryLeftNewDTO.yz_num != "--" && cM.queryLeftNewDTO.yz_num != "无") {
                    aO.push("YZ");
                    return true
                }
            }
            if (cK[cL] == "SRRB") {
                if (cM.queryLeftNewDTO.srrb_num != "--" && cM.queryLeftNewDTO.srrb_num != "无") {
                    aO.push("SRRB");
                    return true
                }
            }
            if (cK[cL] == "YYRW") {
                if (cM.queryLeftNewDTO.yyrw_num != "--" && cM.queryLeftNewDTO.yyrw_num != "无") {
                    aO.push("YYRW");
                    return true
                }
            }
            if (cK[cL] == "WZ") {
                if (cM.queryLeftNewDTO.wz_num != "--" && cM.queryLeftNewDTO.wz_num != "无") {
                    aO.push("WZ");
                    return true
                }
            }
    ...
    function A(cL, cK) {
        ...
        for (var cM = 0; cM < cK.length; cM++) {
            if (cK[cM].toLowerCase() == cL.queryLeftNewDTO.station_train_code.toLowerCase()) {
                return true
            }
        }
        return false
    ...
    function bu() {
        ...
        var cM = bq;
        var cQ = [];
        if (cL.length > 0 || cR.length > 0 || filteredTrainArriveTime.length > 0 || cd.length > 0 || cN.length > 0 || cP.length > 0 || aI.getComboText() != "" || $("#avail_ticket")[0].checked) {
                        ...
                        success: function (cM) {
                            if (cM.data == "N") {
                                ...
                                if (isAsync == ticket_submit_order.request_flag.isAsync) {
                                    if (P.queryLeftNewDTO.train_no.indexOf(cL) > -1 && cO.indexOf(P.queryLeftNewDTO.from_station_telecode) > -1 && cN.indexOf(P.queryLeftNewDTO.to_station_telecode) > -1) {
                                        dhtmlx.createWin({
                                            winId: "confirmG1234",
                    ...
                    if (document.getElementById("autoSubmit").checked) {
                        ...
                        for (var cU = 0; cU < passengerChecked.length; cU++) {
                            ...
                            for (var cV = 0; cV < cO.length; cV++) {
                                ...
                                if (cR.passenger_type != 2) {
                                    if (cR.passenger_name == cL.passenger_name && cR.passenger_id_type_code == cL.passenger_id_type_code && cR.passenger_id_no == cL.passenger_id_no) {
                        ...
                        if (c0[0] == 1 || c0[0] == 2) {
                            ...
                            if ("undefined" == typeof(submitForm)) {
                                var c1 = "secretStr=" + cX + "&train_date=" + $("#train_date").val() + "&tour_flag=" + cK + "&purpose_codes=" + cT + "&query_from_station_name=" + $("#fromStationText").val() + "&query_to_station_name=" + $("#toStationText").val() + "&" + cW + "&cancel_flag=2&bed_level_order_num=000000000000000000000000000000&passengerTicketStr=" + getpassengerTicketsForAutoSubmit() + "&oldPassengerStr=" + getOldPassengersForAutoSubmit()
                            } else {
                                var cM = submitForm();
                                var cS = cM.split(":::");
                                var cZ = cS[0].split(",-,")[0];
                                ...
                                var cY = cS[1].split(",-,")[0];
                                var cP = cS[1].split(",-,")[1];
                                var c1 = escape(cZ) + "=" + escape(cQ) + "&" + cY + "=" + cP + "&secretStr=" + cX + "&train_date=" + $("#train_date").val() + "&tour_flag=" + cK + "&purpose_codes=" + cT + "&query_from_station_name=" + $("#fromStationText").val() + "&query_to_station_name=" + $("#toStationText").val() + "&" + cW + "&cancel_flag=2&bed_level_order_num=000000000000000000000000000000&passengerTicketStr=" + getpassengerTicketsForAutoSubmit() + "&oldPassengerStr=" + getOldPassengersForAutoSubmit()
                            }
                            $.ajax({
                                type: "post",
                                            ...
                                            if (c2.data.isRelogin) {
                                                ...
                                                if (c2.data.isNoActive) {
                                                    ...
                                                    if (c2.data.checkSeatNum) {
                                                        al("很抱歉，无法提交您的订单!", true, "原因： " + c2.data.errMsg, true, "warn")
                                                    } else {
                                                        al("车票信息不合法!", true, "原因： " + c2.data.errMsg, true, "warn")
                                                    }
                                                }
                                            }
                                            return
    ...
    function m(cL, cM) {
        ...
        if (cL.data && undefined != cL.data.result && typeof(cL.data.result) != "undefined") {
            ...
            if (undefined != cN && typeof(cN) != "undefined" && "" != cN) {
                if (cL.data.name && cL.data.card && cL.data.tel) {
                    ...
                    dhtmlx.alert({
                        title: "警告", ok: "确定", text: cN, type: "alert-error", callback: function () {
    ...
    function n(cW) {
        ...
        for (var cS = 0; cS < cQ.length; cS++) {
            ...
            for (var cT = 0; cT < cU; cT++) {
                ...
                tickets_info.push(new br("sdAdd_" + ax(), cL, cM, cR, cN, passengerChecked[cP].passenger_name, passengerChecked[cP].passenger_id_type_code, passengerChecked[cP].passenger_id_type_name, passengerChecked[cP].passenger_id_no, passengerChecked[cP].mobile_no));
                cP++
            }
        }
    }
    ...
    function cD(cL) {
        ...
        if ("X" == canChooseBeds) {
            ...
            cK = $("#autoSubCheckTicketInfoTemplate_chooseBeds").html().replace("<!--", "").replace("-->", "");
            $("#bed_show").show()
        } else {
            $("#bed_show").hide();
    ...
    getpassengerTicketsForAutoSubmit = function () {
        ...
        for (var cQ = 0; cQ < tickets_info.length; cQ++) {
            var cR = "";
            if ("WZ" == tickets_info[cQ].seat_type) {
                cR = aF(k())
            } else {
            ...
            var cS = "0";
            if (cO && cO.length > 0) {
                var cK = tickets_info[cQ].seat_type + "#" + tickets_info[cQ].ticket_type + "#" + tickets_info[cQ].name + "#" + tickets_info[cQ].id_no;
            ...
            var cU = cR + "," + cS + "," + tickets_info[cQ].ticket_type + "," + tickets_info[cQ].name + "," + tickets_info[cQ].id_type + "," + tickets_info[cQ].id_no + "," + (tickets_info[cQ].phone_no == null ? "" : tickets_info[cQ].phone_no) + ",N";
            cL += cU + "_"
        }
    ...
    getOldPassengersForAutoSubmit = function () {
        ...
        for (var cL = 0; cL < passengerChecked.length; cL++) {
            var cK = passengerChecked[cL].passenger_name + "," + passengerChecked[cL].passenger_id_type_code + "," + passengerChecked[cL].passenger_id_no + "," + passengerChecked[cL].passenger_type;
            cM += cK + "_"
        }
        return cM
    };
            ...
            $.ajax({
                ...
                success: function (cS) {
                    if (cS.status) {
                        ...
                        cP = "本次列车，" + (tickets_info[0].seat_type_name).split("（")[0] + "余票";
                        if (parseInt(cT[0]) >= 0) {
                        ...
                        if (cS.data.op_2 == "true") {
                            ...
                            cP += '<font color="red">目前排队人数已经超过余票张数，请您选择其他席别或车次。</font>'
                        } else {
                            if (cS.data.countT > 0) {
                                cP += '目前排队人数<font color="red">' + cS.data.countT + "</font>人，";
                                if (if_show_pass_code_login == "Y") {
                                    cP += "<br/>请确认以上信息是否正确，点击“确认”后，系统将为您分配席位。"
                                }
                            }
                        }
    ...
    function cI() {
        $.ajax({
            ...
            success: function (cK) {
                if (cK.status) {
                    if (cK.data.submitStatus) {
                        ...
                        al("出票失败!", false, "原因： " + cK.data.errMsg + '<a  id="xg_close_win_id">点击修改</a>', true, "lose");
            ...
            error: function (cK, cM, cL) {
                al("订票失败!", true, "很抱歉！网络忙，请关闭窗口稍后再试。", true, "lose");
                return
            }
        })
    }
    ...
    function ay(cK, cM, cL) {
        if (cM <= 5) {
            ...
            if (cM > 30 * 60) {
                al("订单已经提交，预计等待时间超过30分钟，请耐心等待。", false, "", false, "queue")
            } else {
                al("订单已经提交，最新预估等待时间" + cL + "，请耐心等待。", false, "", false, "queue")
            }
        }
    }
    ...
    function Y() {
        ...
        al = function (cU, cR, cO, cN, cQ) {
            var cT = '<div class="tit">' + (cR ? '<span class="colorC">' + cU + "</span>" : cU) + "</div>";
            var cP = "<P>" + cO + "</p>";
            var cS = cR ? '<p>请点击[<a href="' + ctx + 'view/train_order.html?type=2"><strong>我的12306</strong></a>]办理其他业务。您也可以点击[<a href="' + ctx + 'leftTicket/init"><strong>预订车票</strong></a>]，重新规划您的旅程。</p>' : '<P>查看订单处理情况，请点击“<a href="' + ctx + 'view/train_order.html?type=1">未完成订单</a>”</P>';
            $("#iamge_status_id").removeClass().addClass("icon i-" + cQ);
            if (cN) {
            ...
            $("#orderResultInfo_id").html(cT + (cO == "" || cO == null || cO == "undefined" || cO == undefined ? "" : cP) + cS);
        ...
        function cK(cR) {
            ao(cR, false);
            if ("checkticketinfo_id" == cR) {
                var cP = ticketInfoForPassengerForm.queryLeftNewDetailDTO;
                if (cP.to_station_telecode == ticket_submit_order.special_areas.lso || cP.to_station_telecode == ticket_submit_order.special_areas.dao || cP.to_station_telecode == ticket_submit_order.special_areas.ado || cP.to_station_telecode == ticket_submit_order.special_areas.nqo || cP.to_station_telecode == ticket_submit_order.special_areas.tho) {
                    if (cL()) {
            ...
            cO.setDimension($("#content_" + cR).width(), $("#content_" + cR).height() + 10);
        ...
        function cL() {
            for (var cO = 0; cO < limit_tickets.length; cO++) {
                var cN = limit_tickets[cO];
                if ((ticketInfoForPassengerForm.tour_flag == ticket_submit_order.tour_flag.fc || ticketInfoForPassengerForm.tour_flag == ticket_submit_order.tour_flag.gc) && cN.save_status != "" && (cN.id_type == ticket_submit_order.passenger_card_type.passport || cN.id_type == ticket_submit_order.passenger_card_type.work || cN.id_type == ticket_submit_order.passenger_card_type.taiwan)) {
                    return true
                } else {
                    if ((ticketInfoForPassengerForm.tour_flag == ticket_submit_order.tour_flag.wc || ticketInfoForPassengerForm.tour_flag == ticket_submit_order.tour_flag.dc) && (cN.id_type == ticket_submit_order.passenger_card_type.passport || cN.id_type == ticket_submit_order.passenger_card_type.work || cN.id_type == ticket_submit_order.passenger_card_type.taiwan)) {
                        return true
                    }
                }
            }
    ...
    function aP(cK) {
        ...
        var cO = "日一二三四五六";
        return cN.concat(cM).concat("&nbsp;&nbsp;").concat("周").concat(cO.charAt(cL.getDay()))
    }
    ...
    function d() {
        ...
        $("#hbSubmit").click(function () {
            ...
            var cN = "";
            if (cO.length == 0) {
                dhtmlx.alert({title: "提示", ok: "确定", text: "请先选择候补车次！", type: "alert-error"});
                return
            }
            for (var cL = 0; cL < cO.length; cL++) {
                var cM = seatTypeForHB[$(cO[cL]).attr("hbid").split("#")[4].split("_")[0]].split("_")[0];
                var cK = $(cO[cL]).attr("hbid").split("#")[9] + "#" + cM + "|";
                cN += cK
            }
            V(cN)
        })
    ...
    function aL(cL, cM) {
        var cK = dhtmlx.modalbox({targSrc: '<div><img src="' + ctx + 'resources/images/loading.gif"></img></div>'});
        $.ajax({
            type: "post", url: ctx + "login/checkUser", data: {}, beforeSend: function (cN) {
                ...
                dhtmlx.modalbox.hide(cK);
                dhtmlx.alert({title: "提示", ok: "确定", text: "系统忙，请稍后再试！", type: "alert-error"})
            }
        })
    }
    ...
    function ak(cM, cP) {
        ...
        var cO = seatTypeForHB[$(cM).attr("hbid").split("#")[4].split("_")[0]].split("_")[0];
        var cN = $(cM).attr("hbid").split("#")[9] + "#" + cO + "|";
        var cK = ak;
        $.ajax({
            type: "post",
            ...
            success: function (cQ) {
                ...
                if (cR) {
                    ...
                    dhtmlx.alert({title: "提示", ok: "确定", text: cQ.messages[0], type: "alert-error"})
                }
            },
            error: function () {
                dhtmlx.alert({title: "提示", ok: "确定", text: "系统忙，请稍后再试！", type: "alert-error"})
        ...
        $.ajax({
            ...
            success: function (cL) {
                ...
                if (cM) {
                    ...
                    dhtmlx.alert({title: "提示", ok: "确定", text: cL.messages[0], type: "alert-error"})
                }
            }
        })
    }
    ...
    function bA(cL) {
        if (cL == "01" || cL == "11") {
            var cK = "证件信息正在审核中，请您耐心等待，审核通过后可继续完成候补操作。</P>";
            dhtmlx.alert({title: "提示", ok: "确定", text: "身份核验审核中", body: cK, type: "alert-error"})
        } else {
            if (cL == "03" || cL == "13") {
                var cK = "证件信息审核失败，请检查所填写的身份信息内容与原证件是否一致。";
                dhtmlx.alert({
                    title: "提示",
                    ok: "确定",
                ...
                if (cL == "04" || cL == "14") {
                    var cK = "通过人证一致性核验的用户及激活的“铁路畅行”会员可以提交候补需求，请您按照操作说明在铁路12306app上完成人证核验";
                    dhtmlx.alert({title: "提示", ok: "确定", text: "身份核验提醒", body: cK, type: "alert-error"})
                } else {
                    if (cL == "02" || cL == "12") {
                    } else {
                        dhtmlx.alert({title: "提示", ok: "确定", text: "系统忙，请稍后再试！", type: "alert-error"})
    ...
    function bT(cL) {
        ...
        if ($(cL).hasClass("item-cphd cphd-active")) {
            ...
            if ($('.cart-tlist li[tdate="' + cK + '"]').length == alowHBMaxNum) {
                dhtmlx.alert({title: "提示", ok: "确定", text: hb_max_msg, type: "alert-error"});
                return
            }
            ak(cL, function () {
                $(cL).attr("class", "item-cphd cphd-active");
                if (!$(cL).prev().hasClass("cphd-active")) {
                }
                x(cM, "add");
                u(cL, cM)
            })
    ...
    function x(cQ, cN) {
        ...
        if (cN == "add") {
            $(".buy-cart").show();
            var cO = '<li tdate="' + cM[0] + '" hbid="' + cQ + '"><div>' + cM[0] + "    " + cM[6] + "  -  " + cM[8] + "</div><div>" + cM[10] + " | " + seatTypeForHB[cM[4].split("_")[0]].split("_")[1] + ' <span style="display:none;"></span></div><div name="suc_rate" hbid="' + cQ + '" class="cart-odds"></div><a href="javascript:void(0)" onclick="deleteHB(this)" class="del">删除</a></li>';
        ...
        if ($(".cart-tlist li").length == 0) {
            ...
            var cK = $($(".cart-tlist li")[0]).attr("hbid").split("#")[0];
            $(".cart-bd").show()
        }
    }
    ...
    function u(cM, cO) {
        ...
        var cP = $(cM).offset();
        var cK = $('<img id="flyer" src="' + ctx + 'resources/images/oval.png" style="overflow:hidden;position:absolute;z-index:1500;" width="11" height="11" />');
        try {
            cK.fly({
                start: {left: cP.left + 27, top: cP.top - $(window).scrollTop() + 10},
                end: {left: cN.left + 10, top: cN.top - $(window).scrollTop() + 10, width: 0, height: 0},
                onEnd: function () {
                    this.destory()
                },
                autoPlay: true,
        ...
        $.ajax({
            ...
            success: function (cM) {
                ...
                if (cN && cN.flag) {
                    var cO = cN.flag[0];
                    if (cO.level == 3) {
                        $('div[name="suc_rate"][hbid="' + cL + '"]').after('<span class="odds-small">' + cO.info + "</span>")
                    } else {
                        if (cO.level == 2) {
                            $('div[name="suc_rate"][hbid="' + cL + '"]').after('<span class="odds-mid">' + cO.info + "</span>")
                        } else {
                            if (cO.level == 1) {
                                $('div[name="suc_rate"][hbid="' + cL + '"]').after('<span class="odds-large">' + cO.info + "</span>")
                            }
                        }
                    }
                }
    ...
    deleteHB = function (cL) {
        $(cL).parent().remove();
        var cM = $(cL).parent().attr("hbid");
        var cK = $('td[hbid="' + cM + '"]');
        if ($(cK).prev().hasClass("cphd-active-prev")) {
            $(cK).prev().removeClass()
        }
        if ($(cK).next().hasClass("item-cphd cphd-active")) {
    ...
    showTicketPrice = function (cO) {
        ...
        var cS = $(cO).parent("tr").children("td").children("div").children("div").children("span").attr("id");
        if (undefined == cS || cS == null || "undefined" == typeof(cS)) {
            cS = $(cO).attr("id")
        }
        $("#price_" + cP).hide();
        $("#tp-list-price").hide();
            ...
            $.ajax({
                ...
                success: function (cU) {
                    if (cU.status) {
                        ...
                        $("#price_" + cP).show();
                        if (cQ && c(cQ)) {
                            $("#price_" + cP).find("td").eq(0).html('<a class="ad-tlist-hot" href="javascript:void(0);">移动宾馆 免费晚餐 快捷舒适 准时正点</a>')
                        } else {
                            $("#price_" + cP).find("td").eq(0).html("")
                        }
                        if (cU.data.PM != "--") {
    ...
    checkHover = function (cL, cK) {
        if (getEvent(cL).type == "mouseover") {
            return !$.contains(cK, getEvent(cL).relatedTarget || getEvent(cL).fromElement) && !((getEvent(cL).relatedTarget || getEvent(cL).fromElement) === cK)
        } else {
            return !$.contains(cK, getEvent(cL).relatedTarget || getEvent(cL).toElement) && !((getEvent(cL).relatedTarget || getEvent(cL).toElement) === cK)
        }
    };
    ...
    submitOrderRequest = function (cL, cK) {
        $.ajax({
            type: "post", url: ctx + "login/checkUser", data: {}, beforeSend: function (cM) {
                cM.setRequestHeader("If-Modified-Since", "0");
                cM.setRequestHeader("Cache-Control", "no-cache")
            }, success: function (cM) {
                var cP;
                ...
                if (cM.data.flag) {
                    ...
                    if (B == "0X00") {
                        ...
                        for (i = (studentComPerArr.length - 1); i >= 0; i = i - 2) {
                            if (G(studentComPerArr[i - 1]) <= G(cP) && G(studentComPerArr[i]) >= G(cP)) {
                                cO = true;
                                break
                            }
                        }
    ...
    function Z(cX, cQ) {
        ...
        if ("undefined" == typeof(submitForm)) {
            var cO = "secretStr=" + cX + "&train_date=" + $("#train_date").val() + "&back_train_date=" + $("#back_train_date").val() + "&tour_flag=" + cK + "&purpose_codes=" + cE() + "&query_from_station_name=" + $("#fromStationText").val() + "&query_to_station_name=" + $("#toStationText").val() + "&" + cV
        } else {
            var cL = submitForm();
            var cW = cL.split(":::");
            var cR = cW[0].split(",-,")[0];
            ...
            var cP = cW[1].split(",-,")[0];
            var cT = cW[1].split(",-,")[1];
            var cO = escape(cR) + "=" + escape(cU) + "&" + cP + "=" + cT + "&secretStr=" + cX + "&train_date=" + $("#train_date").val() + "&back_train_date=" + $("#back_train_date").val() + "&tour_flag=" + cK + "&purpose_codes=" + cE() + "&query_from_station_name=" + $("#fromStationText").val() + "&query_to_station_name=" + $("#toStationText").val() + "&" + cV
        }
        var cV = checkusermdId != undefined ? "&_json_att=" + encodeURIComponent(checkusermdId) : "";
        $.ajax({
            type: "post",
                    ...
                    if (cM.test(cO) && cO.length > 4) {
                        ...
                        if (cO.length < 2) {
                            ...
                            if ($.inArray(cO, ccSelected) < 0) {
                                var cK = "<span name='prior_train-span' class='sel-box w80'>" + cO + "<a class='close' href='javascript:' onclick='$.removeSel(this,\"" + cO + "\",4)'></a></span>";
                ...
                if (cV) {
                    if (cO.indexOf(cY) > -1) {
                        ...
                        if (cU && cU.length > 0 && $.inArray(cO, cU) > -1) {
                            cP += '<li style="width: 140px;" traincode=' + cO + ' name="yxtrainli" class="cur"><span style="font-size:15px;">' + cQ + '<span style="color:red;">' + cY + "</span>" + cW + "</span>" + cM + "</li>"
                        } else {
                            cP += '<li style="width: 140px;" traincode=' + cO + ' name="yxtrainli"><span style="font-size:15px;">' + cQ + '<span style="color:red;">' + cY + "</span>" + cW + "</span>" + cM + "</li>"
                        }
                    }
                }
            }
    ...
    function I(cK, cL) {
        ...
        $("#yxTrain_page").html(aQ(cK, cM)).show()
    }

    function aQ(cS, cN) {
        var cO = "";
        cO += (cS == 0) ? "" : '<a href="javascript:void(0);" onclick="$.click_YX_page(' + (cS - 1) + ')" class="prev">上一页</a>';
        var cT = cS + 1;
        var cP = cN;
        var cQ = 2;
        var cR = 5;
        ...
        if (cP < cR) {
            for (var cM = 1; cM < cP + 1; cM++) {
                if (cT == cM) {
                    cO += '<a href="javascript:void(0);" onclick="$.click_YX_page(' + (cM - 1) + ')" class="on">' + (cM) + "</a>"
                } else {
                    cO += '<a href="javascript:void(0);" onclick="$.click_YX_page(' + (cM - 1) + ')">' + (cM) + "</a>"
                }
            }
        } else {
        ...
        cO += (cS == cN - 1) ? "" : '<a href="javascript:void(0);" onclick="$.click_YX_page(' + (cS + 1) + ')" class="next">下一页</a>';
        return cO
    }
    ...
    function bn(cS, cN) {
        ...
        var cO = "";
        cO += (cS == 0) ? "" : '<a href="javascript:void(0);" onclick="$.click_passenger_page(' + (cS - 1) + ')" class="prev">上一页</a>';
        var cT = cS + 1;
        var cP = cN;
        var cQ = 2;
        var cR = 5;
        ...
        if (cP < cR) {
            for (var cM = 1; cM < cP + 1; cM++) {
                if (cT == cM) {
                    cO += '<a href="javascript:void(0);" onclick="$.click_passenger_page(' + (cM - 1) + ')" class="on">' + (cM) + "</a>"
                } else {
                    cO += '<a href="javascript:void(0);" onclick="$.click_passenger_page(' + (cM - 1) + ')">' + (cM) + "</a>"
                }
            }
        } else {
            for (var cM = cK; cM < cL; cM++) {
        ...
        cO += (cS == cN - 1) ? "" : '<a href="javascript:void(0);" onclick="$.click_passenger_page(' + (cS + 1) + ')" class="next">下一页</a>';
        return cO
    }
    ...
    jQuery.extend({
        todo_submitOrderRe: function (cL, cK) {
            ...
            var cK = [];
            var cM = 0;
            cK[cM++] = '<li><input name="cc_type" value="G" type="checkbox" class="check" /><label for="">GC-高铁/城际</label></li>';
            cK[cM++] = '<li><input name="cc_type" value="D" type="checkbox" class="check" /><label for="">D-动车</label></li>';
            cK[cM++] = '<li><input name="cc_type" value="Z" type="checkbox" class="check" /><label for="">Z-直达</label></li>';
            cK[cM++] = '<li><input name="cc_type" value="T" type="checkbox" class="check" /><label for="">T-特快</label></li>';
            cK[cM++] = '<li><input name="cc_type" value="K" type="checkbox" class="check" /><label for="">K-快速</label></li>';
            cK[cM++] = '<li><input name="cc_type" value="QT" type="checkbox" class="check" /><label for="">其他</label></li>';
            $("#_ul_station_train_code").html(cK.join(""));
            if (train_tour_flag == "gc" && "Y" == isDwTicketResign) {
                var cO = $("#_ul_station_train_code li");
                for (var cL = 2, cN = cO.length; cL < cN; cL++) {
                    cO.eq(cL).find("input").attr("disabled", "disabled");
                    cO.eq(cL).find("label").attr("for", "").attr("style", "color: rgb(153, 153, 153)")
                }
            }
            ...
            if (passengerAll) {
                ...
                if (cO != "" && cO != "输入乘客姓名") {
                    ...
                    for (var cX = 0; cX < c0; cX++) {
                        ...
                        if (cW.passenger_name.indexOf(cO) > -1 || (cW.first_letter && cW.first_letter.toUpperCase().indexOf(cO.toUpperCase()) > -1)) {
                            cK.push(cW)
                        }
                    }
                } else {
                    cK = passengerAll.slice(passengerPageSize * (c2), Math.min(passengerPageSize * (c2 + 1), passengerAll.length))
                }
                var cV = cK.length;
                var cT = [];
                var cP = 0;
                for (var cX = 0; cX < cV; cX++) {
                    ...
                    var cU = c1 == "成人" ? cW.passenger_name : cW.passenger_name + "(" + c1 + ")";
                    cU = cU.substring(0, 9);
                    if (cO != "" && cO != "输入乘客姓名") {
                        if (cW.passenger_name.indexOf(cO) > -1 || (cW.first_letter && cW.first_letter.toUpperCase().indexOf(cO.toUpperCase()) > -1)) {
                            cP++;
                            ...
                            cT[cX] = "<li style='width:110px' " + cL + " p_value='" + cW.passenger_name + "(" + c1 + ")(" + cW.passenger_id_no + ")' name='" + cW.passenger_type + "' codeType='" + cW.passenger_id_type_code + "' flag='" + cW.total_times + "'>" + cU + "</li>"
                        }
                    } else {
                        cP++;
                        if ($.pHasInSelected(cW)) {
                ...
                $("#passenger_page").html(bn(c2, cQ)).show()
            }
            $("#buyer-list li").click(function () {
                ...
                if (!$(this).hasClass("cur")) {
                    if (c5 < 6) {
                        var c3 = "";
                        var c4 = true;
                        if (c7.indexOf("成人") > -1 || c7.indexOf("残疾军人、伤残人民警察") > -1) {
                            c3 = "<span name='" + c7 + "' class='sel-box w80'><a href='javascript:' onclick='$.addChildPassenger(\"" + c7 + "\");' style='position:static;background:none;width:auto;' title='您可点击此乘车人添加儿童票。'>" + c7 + "</a><a class='close' href='javascript:' onclick='$.removeSel(this,\"" + c7 + "\",1)'></a></span>";
                            ...
                            if (c7.indexOf("学生") > -1) {
                                var c6 = $(this);
                                if ($.checkSeatTypes()) {
                                    c3 = "<span name='" + c7 + "' class='sel-box w80'>" + c7 + "<a class='close' href='javascript:' onclick='$.removeSel(this,\"" + c7 + "\",1)'></a></span>";
                                    $("#setion_postion").append(c3);
                                    $.checkedPasseanger(c7)
                                } else {
                                    ...
                                    dhtmlx.createWin({
                                        ...
                                        okCallBack: function () {
                                            ...
                                            c3 = "<span name='" + c7 + "' class='sel-box w80'>" + c8 + "<a class='close' href='javascript:' onclick='$.removeSel(this,\"" + c7 + "\",1)'></a></span>";
                                            $("#setion_postion").append(c3);
                                ...
                                if (c7.indexOf("儿童") > -1) {
                                    c3 = "<span name='" + c7 + "' class='sel-box w80' title='如需修改旅客类型，请修改相应常用联系人信息。'>" + c7 + "<a class='close' href='javascript:' onclick='$.removeSel(this,\"" + c7 + "\",1)'></a></span>";
                                    $("#setion_postion").append(c3);
                                    $.checkedPasseanger(c7)
                                } else {
                                    c3 = "<span name='" + c7 + "' class='sel-box w80'>" + c7 + "<a class='close' href='javascript:' onclick='$.removeSel(this,\"" + c7 + "\",1)'></a></span>";
                ...
                success: function (cL) {
                    ...
                    if (cL.status) {
                        if (cL.data.noLogin == "true") {
                            ...
                            if (cL.data.exMsg != "" && cL.data.exMsg != null && cL.data.exMsg != "null") {
                                b(cL.data.exMsg);
                                return
                            }
                            $("#sel-buyer").show();
            ...
            for (var cK = 0; cK < cL; cK++) {
                if (cM[cK].passenger_name == cN.passenger_name && cM[cK].passenger_id_type_code == cN.passenger_id_type_code && cN.passenger_id_no == cM[cK].passenger_id_no) {
                    return true
                }
            }
            return false
            ...
            if (cL > 0) {
                for (var cK = 0; cK < cL; cK++) {
                    ...
                    if (cM.passenger_name == cN.passenger_name && cM.passenger_id_type_code == cN.passenger_id_type_code && cM.passenger_id_no == cN.passenger_id_no) {
                        return true
                    }
                }
            }
            ...
            var cM = $("#yxtraininput").val().toUpperCase();
            var cK = $("#yxtrain_code").height();
            if (y(cM, cL)) {
                cJ(1)
            } else {
            ...
            var cK = new Date(cM.substring(0, 4) + "/" + cM.substring(5, 7) + "/" + cM.substring(8, 10)).getTime();
            ...
            var cM = "";
            for (var cK = 0; cK < cL.length; cK++) {
                var cO = $(cL[cK]).attr("hbid").split("#")[0];
                if (cM.indexOf(cO) == -1) {
                    cM += cO
                }
            }
            ...
            if (cM.length / 10 == 2) {
                dhtmlx.alert({title: "提示", ok: "确定", text: hb_date_msg, type: "alert-error"});
                return false
            }
            if (cN != 1) {
                dhtmlx.alert({title: "提示", ok: "确定", text: hb_date_msg_diff, type: "alert-error"});
                return false
            }
            return true
            ...
            cJ(2);
            var cM = $("#fromStationText").val() + "#" + $("#toStationText").val() + "#" + $("#train_date").val();
            if (trainListForIE.length == 0 || yxTrainChange != cM) {
                B = cE();
                var cO = B == "0X00" ? true : false;
                var cL = train_tour_flag == "fc" ? $.trim($("#back_train_date").val()) : $.trim($("#train_date").val());
                var cK = b4(cL, cO);
                if (!cK) {
                    $("#yxtraindiv").hide();
                ...
                bb();
                $.ajax({
                    type: "get", isTakeParam: false, beforeSend: function (cP) {
                        cP.setRequestHeader("If-Modified-Since", "0");
                        cP.setRequestHeader("Cache-Control", "no-cache")
                    }, url: ctx + CLeftTicketUrl, data: cN, timeout: 10000, success: function (cR) {
                        if (cR.status) {
                            ...
                            var cU = "";
                            if (train_tour_flag != null && train_tour_flag == "fc") {
                                var cX = "<strong>".concat($("#fromStationText").val()).concat(" --> ").concat($("#toStationText").val()).concat("（").concat(aP($("#back_train_date").val())).concat('）</strong>共计<strong id="trainum">').concat(cR.data.length).concat("</strong>个车次");
                                if (ch(cR.data)) {
                                ...
                                if ($("#auto_query").is(":checked")) {
                                    ...
                                    cX = cX.concat(cW + "<input type='checkbox' class='check' id='filterTic' /><div id='filterTicDiv' style='display:inline'><strong><label for='filterTic' style='cursor: pointer;'>仅查看刷到车次</label></strong></div>")
                                }
                                ...
                                var cX = "<strong>".concat($("#fromStationText").val()).concat(" --> ").concat($("#toStationText").val()).concat("（").concat(aP($("#train_date").val())).concat('）</strong>共计<strong id="trainum">').concat(cR.data.length).concat("</strong>个车次");
                                if (ch(cR.data)) {
                                    cP = "<p class='ad-gt' id='DW_SHOW_STR' data='1'>高铁动卧 夕发朝至 风雨无阻 省时省钱</p>"
                                } else {
                                    if (hainan_limit_msg && an(cN, cR.data)) {
    ...
    function aD() {
        var cK = $("#queryPriceTemplate").html().replace("<!--", "").replace("-->", "");
        $.templates({priceTableTemplate: cK});
        var cK = $("#fromStationNameTemplate").html().replace("<!--", "").replace("-->", "");
        $.templates({stationNameTableTemplate: cK});
        var cK = $("#toStationNameTemplate").html().replace("<!--", "").replace("-->", "");
        $.templates({toStationNameTableTemplate: cK});
        var cK = $("#seatTypeTemplate").html().replace("<!--", "").replace("-->", "");
        $.templates({seatTypeTemplate: cK});
        var cK = $("#stationinfoTemplate").html().replace("<!--", "").replace("-->", "");
    ...
    function b0(cL) {
        ...
        aI.clearAll();
        $(cL).each(function () {
            cK.push([this.queryLeftNewDTO.station_train_code, this.queryLeftNewDTO.station_train_code])
        });
        aI.addOption(cK);
    ...
    function ag() {
        ...
        $("#loginSubAsyn").click(function () {
            if (!cK) {
                var cL = a9();
                if (is_uam_login == "Y") {
                    if (if_show_pass_code_login == "Y" && !verifyRandCodeUAM($("#randCode")[0], cL)) {
                        cK = false;
                        return
                    }
                    cK = true;
                    ...
                    if (if_show_pass_code_login == "Y" && !verifyRandCode($("#randCode")[0], cL)) {
                        cK = false;
                        return
                    }
                    cK = true;
    ...
    function bd() {
        window.sucessCallback = function () {
            ...
            if (isAsync == ticket_submit_order.request_flag.isAsync) {
                if (P.queryLeftNewDTO.train_no.indexOf(cK) > -1 && cM.indexOf(P.queryLeftNewDTO.from_station_telecode) > -1 && cL.indexOf(P.queryLeftNewDTO.to_station_telecode) > -1) {
                    dhtmlx.createWin({
                        winId: "confirmG1234",
                        closeWinId: ["close_conifrmdialog_G1234", "cancel_dialog_G1234"],
                        okId: "goto_integration_G1234",
    ...
    function bb() {
        ...
        if (train_tour_flag != null && train_tour_flag != "" && train_tour_flag == "fc") {
            cS = jQuery.inArray($("#back_train_date").val().substring(5, 10), change_dates_arr)
        } else {
            cS = jQuery.inArray($("#train_date").val().substring(5, 10), change_dates_arr)
        }
        if (cS != "-1") {
            cS = cS + 1;
            cX = firstShow;
            cL = endShow;
            if (parseInt(cS) >= parseInt(firstShow) && parseInt(cS) <= parseInt(endShow)) {
                if (isOther) {
            ...
            $("#date_range>ul>li").removeClass("sel");
            if (cU) {
                $("#date_range>ul>li:nth-child(" + cX + ")").children("span:first").removeClass();
                $("#date_range>ul>li:nth-child(" + cX + ")").children("span:last").removeClass();
            ...
            $("#date_range>ul>li:nth-child(" + cS + ")").children("span:last-child").removeClass();
            $("#date_range>ul>li:nth-child(" + cS + ")").children("span:first-child").addClass("hide");
            ce = $("#date_range>ul>li:nth-child(" + cS + ")").children("span:first-child").text()
        }
    }
    ...
    String.prototype.toDate = function () {
        ...
        for (var cL in cN) {
            if (new RegExp("(" + cL + ")").test(style)) {
                cK[cN[cL]] = this.substring(cM.indexOf(RegExp.$1), cM.indexOf(RegExp.$1) + RegExp.$1.length)
            }
        }
    ...
    function D(cO) {
        ...
        var cK = ($("#" + cO).val().split(" ")[0] + " 00:00:00").toDate().getTime();
    ...
    function cj(cK) {
        if (isSaveQueryLog == "Y") {
            $.ajax({
                type: "get", isTakeParam: false, beforeSend: function (cL) {
                    cL.setRequestHeader("If-Modified-Since", "0");
                    cL.setRequestHeader("Cache-Control", "no-cache")
                }, url: ctx + "leftTicket/log", data: cK, timeout: 15000, error: function (cL, cN, cM) {
                }, success: function (cL) {
                }
            })
        }
    ...
    function aa() {
        ...
        if (tickets_info && tickets_info.length > 0) {
            ...
            if (canChooseSeats && "Y" == canChooseSeats && "Y" == cO) {
                if (choose_Seats) {
                    var cL = "*如果本次列车剩余席位无法满足您的选座需求，系统将自动为您分配席位。";
                    if ("M" == cK && choose_Seats.indexOf("M") > -1) {
                    ...
                    if ("O" == cK && choose_Seats.indexOf("O") > -1) {
                        $("#id-seat-sel").css("display", "block");
                    ...
                    if ("P" == cK && choose_Seats.indexOf("P") > -1) {
                        $("#id-seat-sel").css("display", "block");
                    ...
                    if ("9" == cK && choose_Seats.indexOf("9") > -1) {
                        $("#id-seat-sel").css("display", "block");
                        $("#tedeng1").css("display", "block");
                        if (tickets_info.length > 1) {
                            $("#tedeng2").css("display", "block")
...
jQuery.extend({
    pop_secretStr: "", pop_start_time: "", popup_isPop: true, pop_callback: function () {
