...
public class HuffmanTest {
    ...
    public static void main(String[] args) {
        ...
        String path = "src/main/resources/kaixinxiaoxiaole.jpg";
        byte[] imgBytes = readImg(path);
...
//            buffer.append(encodInfo.get(character));
        ...
        System.out.println("Success : " + oriStr.equals(decodedStr));
        System.out.println("Encoed binary string:\t\t" + encodedBinariStr);
        System.out.println("Size of encoded string:\t\t" + encodedBinariStr.length());

        System.out.println("binary string of UTF-8:\t\t"
                + getStringOfByte(oriStr, Charset.forName("UTF-8")));
        System.out.println("Size of origin string:\t\t" + getStringOfByte(oriStr, Charset.forName("UTF-8")).length());
        System.out.println("binary string of UTF-16:\t"
                + getStringOfByte(oriStr, Charset.forName("UTF-16")));
        System.out.println("Size of origin string:\t\t" + getStringOfByte(oriStr, Charset.forName("UTF-16")).length());
        System.out.println("binary string of US-ASCII:\t"
                + getStringOfByte(oriStr, Charset.forName("US-ASCII")));
        System.out.println("Size of origin string:\t\t" + getStringOfByte(oriStr, Charset.forName("US-ASCII")).length());
        System.out.println("binary string of GB2312:\t"
                + getStringOfByte(oriStr, Charset.forName("GB2312")));
        System.out.println("Size of origin string:\t\t" + getStringOfByte(oriStr, Charset.forName("GB2312")).length());
    }
